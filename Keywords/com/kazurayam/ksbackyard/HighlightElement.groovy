...
public class HighlightElement {
	 ...
	 */
	public static final Set<String> DEFAULT_HIGHLIGHTING_KW = new HashSet(['click', 'selectOptionByIndex', 'selectOptionByLabel', 'selectOptionByValue', 'setEncryptedText', 'setText'])
