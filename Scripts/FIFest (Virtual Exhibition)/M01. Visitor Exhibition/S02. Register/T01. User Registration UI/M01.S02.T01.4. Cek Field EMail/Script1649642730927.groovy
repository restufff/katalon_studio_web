...
//Case 2. Cek Jika Field Email tidak diisi dalam format email

WebUI.setText(findTestObject('Object Repository/Page_Safari 2021/txtFullname'), randomString(chars, 10))

WebUI.setText(findTestObject('Object Repository/Page_Safari 2021/txtEmail'), randomString(chars, 10)+' '+randomInt.toString())
...
//Case 3. Cek Jika Field Email tidak diisi
WebUI.setText(findTestObject('Object Repository/Page_Safari 2021/txtFullname'), randomString(chars, 10))
...
WebUI.setText(findTestObject('Object Repository/Page_Safari 2021/txtEmail'), '')
