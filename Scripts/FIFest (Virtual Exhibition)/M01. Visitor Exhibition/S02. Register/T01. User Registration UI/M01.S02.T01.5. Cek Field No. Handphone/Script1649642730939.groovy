...
//Case 2. Cek Jika Field No. Handphone diisi kurang dari 13 digit
...
WebUI.setText(findTestObject('Object Repository/Page_Safari 2021/txtPhone'), '0811'+phone)
...
if(WebUI.verifyElementNotPresent(findTestObject("Object Repository/Page_Safari 2021/btn_Skip"),3)) {
	

//Case 3. Cek Jika Field No. Handphone tidak diisi
	WebUI.setText(findTestObject('Object Repository/Page_Safari 2021/txtFullname'), randomString(chars, 10))
} else if(WebUI.verifyElementPresent(findTestObject("Object Repository/Page_Safari 2021/btn_Skip"),3)) {
...
WebUI.setText(findTestObject('Object Repository/Page_Safari 2021/txtPhone'), '')
...
//Case 4. Cek Jika Field No. Handphone tidak diisi dengan format awalan 0xxx
	WebUI.setText(findTestObject('Object Repository/Page_Safari 2021/txtFullname'), randomString(chars, 10))
} else if(WebUI.verifyElementPresent(findTestObject("Object Repository/Page_Safari 2021/btn_Skip"),3)) {
...
WebUI.setText(findTestObject('Object Repository/Page_Safari 2021/txtPhone'), '1234'+phone)
