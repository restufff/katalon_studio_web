...
//Case 1. Cek Input Kode OTP salah / expired
...
WebUI.sendKeys(findTestObject('Object Repository/Page_Test exhibbition 2 - Forgot Password/button_Kirim OTP'), Keys.chord(
        Keys.ENTER))

WebUI.setText(findTestObject('Page_Test exhibbition 2 - Forgot Password/txt_OTP'), '6217') //Input OTP acak

WebUI.sendKeys(findTestObject('Object Repository/Page_Test exhibbition 2 - Forgot Password/button_Selanjutnya'), Keys.chord(
	Keys.ENTER))
