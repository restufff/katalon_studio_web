...
//Case 1. Cek User Membaca Petunjuk Penggunaan
...
//Case 2. Cek User Klik Tombol Next pada Petunjuk Penggunaan
...
WebUI.takeScreenshot((GlobalVariable.sspath + GlobalVariable.tcName) + '-2.png')
	...
	WebUI.takeScreenshot((GlobalVariable.sspath + GlobalVariable.tcName) + '-2-1.png')
}


WebUI.takeScreenshot((GlobalVariable.sspath + GlobalVariable.tcName) + '-3.png')

//Case 3. Cek User Klik tombol Lobby pada Petunjuk Penggunaan
WebUI.click(findTestObject('Object Repository/Page_Test exhibbition 2/btn_Lobby'))

WebUI.delay(5)
WebUI.takeScreenshot((GlobalVariable.sspath + GlobalVariable.tcName) + '-3-1.png')
